        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailOtpCode = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    EmailOtpExpiresAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    EmailOtpAttempts = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    EmailOtpLockedUntil = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "Draft"),
                    TotalQuestionsCache = table.Column<int>(type: "int", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentDiplomas", x => x.EnrollmentId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    AllowMultipleCorrectAnswers = table.Column<bool>(type: "bit", nullable: true),
                    OptionsCount = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Options_Questions_MCQQuestionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentAnswer = table.Column<bool>(type: "bit", nullable: true),
                    CorrectTrueAnswer = table.Column<bool>(type: "bit", nullable: true),
                    IsCorrect = table.Column<bool>(type: "bit", nullable: false),
